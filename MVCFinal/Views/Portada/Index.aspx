...
<html>
    <head>
        ...
        <link href="<%= Url.Content("~/Content/js/colorbox/colorbox.css") %>"  rel='stylesheet' type='text/css'>
    ...
    <body>
                ...
                <div class="navbar navbar-default" role="navigation">
                    <div class="container">
                        <div class="navbar-header">
                                ...
                                <a href="#" class="navbar-brand"><img src="../../Content/img/logo.png" alt="Ubicatrex" title="Ubicatrex" /></a>
                        </div>
                        <div class="navbar-collapse collapse" id="templatemo-nav-bar">
                            <ul class="nav navbar-nav navbar-right" style="margin-top: 40px;">
                                <li class="active"><a href="#templatemo-top">PRINCIPAL</a></li>
                                <li><a href="#templatemo-about">ACERCA DE</a></li>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="templatemo-service-item">
                            <div><img src="images/leaf.png" alt="icon" />
                            ...
                            <div class="text-center">
                            	<a href="#" 
                                	class="templatemo-btn-read-more btn btn-orange">LEER MAS</a>
                            </div>
                            <br class="clearfix"/>
                        </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="templatemo-line-header" >
                        <div class="text-center">
                            <hr class="team_hr team_hr_left hr_gray"/><span class="txt_darkgrey"> PORTFOLIO </span> <hr class="team_hr team_hr_right hr_gray" />
                        </div>
                    </div>
                    <div class="clearfix"></div>
                ...
                <div class="clearfix"></div>
                <div class="text-center">
                    AQUI VAN ALGUNAS FOTOS DE LUGARES
            ...
            <div class="container">
                <div class="row">
                    <div class="templatemo-line-header" style="margin-top: 0px;" >
                        <div class="text-center">
                            <hr class="team_hr team_hr_left hr_gray"/><span class="span_blog txt_darkgrey">FEEDBACK</span> <hr class="team_hr team_hr_right hr_gray" />
            ...
            <div class="container">
                <div class="row" style="margin-top:20px;">
                        ...
                        <div class="col-md-7 tweet_txt" >
                                <span>En los momentos de crisis, solo la imaginacion es mas importante que el conocimiento. Albert Einstein. Con Ubicatrex descubriras eso. </span>
                                <br/>
                ...
                <div class="row">
                    <div class="text-center">
                        ...
                        <div class="footer_bottom_content">
                   			<span id="footer-line">Copyright@ 2017 Ubicatrex Maps</span></div>
        ...
        <script src="<%= Url.Content("~/Content/js/stickUp.min.js")%>"  type="text/javascript"></script>
        <script src="<%= Url.Content("~/Content/js/colorbox/jquery.colorbox-min.js")%>"  type="text/javascript"></script>
        <script src="<%= Url.Content("~/Content/js/templatemo_script.js")%>"  type="text/javascript"></script>
    </body>
</html>
